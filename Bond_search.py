...
web_actions.write_operation_xpath(Locators.Smaller_date_xp,"2.2.2027")
time.sleep(random.randint(2,6))
web_actions.click_operation_Xpath(Locators.Bigger_date_xp)
web_actions.clear_operation_A_xpath(Locators.Bigger_date_2_xp)
web_actions.write_operation_xpath(Locators.Bigger_date_2_xp,"1.4.2035")
...
web_actions.write_operation_xpath(Locators.Gelisteter_Zeitraum_smaller_date_xp,"1.1.2020")
...
web_actions.write_operation_xpath(Locators.Gelisteter_Zeitraum_Bigger_date_xp,"1.8.2023")
time.sleep(random.randint(2,6))
...
time.sleep(random.randint(2,6))
web_actions.click_operation_id_A(Locators.Wahrung_click_new_ID)
...
#df.to_excel(excel_writer = "/var/www/10/raikkulenz/sites/raikkulenz.kapsi.fi/www/python/anleihen/test.xlsx")
df.to_excel(excel_writer = "c:\\temp\\Stuttgart_test.xlsx")

config.driver.quit()

a="konifer"
web_actions.do_something(a)
web_actions.do_something_else()